      ...
      <div class="d-flex align-items-end row">
       ...
       <div class="col-4 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
            <img src="{{ asset('assets/img/illustrations/supervisor.png')}}" height="140" alt="view sales" />
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-xl-8 col-md-12">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        <h5 class="card-title mb-0">Supervisor Statistics</h5>
...
<div class="col-xl-6 col-xl-6">
  <div class="card h-100">
    <div class="card-header d-flex justify-content-between ">
      <h5 class="card-title mb-0">Supervisor KPI Overview</h5>
    </div>
