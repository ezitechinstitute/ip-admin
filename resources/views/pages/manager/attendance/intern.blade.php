                ...
                <div class="table-responsive overflow-auto" style="max-height: 700px;">
                    <table class="datatables-users table dataTable dtr-column" id="DataTables_Table_0"
                        ...
                        <thead class="border-top sticky-top bg-card">
                            <tr>
                                <th class="dt-orderable-asc dt-orderable-desc text-nowrap">ETI ID</th>
                                ...
                                <th class="dt-orderable-asc dt-orderable-desc text-nowrap">Intern Type</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span class="text-heading text-nowrap">{{ $leave->eti_id }}</span></td>
                                ...
                                <td><span class="text-heading text-nowrap">{{ $leave->technology }}</span></td>
                                <td><span class="text-heading text-nowrap text-capitalize">{{ $leave->intern_type }}</span></td>
