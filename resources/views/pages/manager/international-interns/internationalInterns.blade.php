...
@endphp
  ...
  <div class="col-12 mb-6">
    ...
    <h4 class="mt-6 mb-1">International Interns</h4>
  </div>
  {{-- Error Messages --}}
  @if($errors->any())
    ...
    <div class="card-datatable">
      <div id="DataTables_Table_0_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
        ...
        <div
          ...
          <form method="GET" action="{{ route('manager.international.interns') }}" id="filterForm" class="d-flex gap-2">
  ...
  'excel_manager_international_interns'))
              ...
              <div class="dropdown-menu" style="z-index: 1021" aria-labelledby="btnGroupDrop1">
               <a class="dt-button dropdown-item" href="{{ route('manager.international.interns.export', request()->all()) }}">
    <span>
                ...
                <tr>
                  ...
                  <th data-dt-column="2" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc text-nowrap"
                    aria-label="Profile Picture" tabindex="0"><span class="dt-column-title" role="button">Profile
                      image</span><span class="dt-column-order"></span></th>
                  <th data-dt-column="3" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc text-nowrap"
                    aria-label="Full Name" tabindex="0"><span class="dt-column-title" role="button">Full
                  ...
                  <th data-dt-column="7" rowspan="1" colspan="1" class="dt-orderable-none text-nowrap"
                    aria-label="Join Date"><span class="dt-column-title">Country</span><span
                      class="dt-column-order"></span></th>
                  <th data-dt-column="7" rowspan="1" colspan="1" class="dt-orderable-none text-nowrap"
    ...
    $intern->image
        ...
        : asset('assets/img/avatars/1.png') 
                  ...
                  <td><span class="text-heading text-nowrap">{{$intern->country}}</span></td>
                  ...
                  <td>
                    @if($manager && \Illuminate\Support\Facades\Gate::forUser($manager)->allows('check-privilege',
  'edit_status_manager_international_interns') || $manager && \Illuminate\Support\Facades\Gate::forUser($manager)->allows('check-privilege',
  'remove_manager_international_interns'))
                    <div class="dropdown">
                    <a href="javascript:;"
                    ...
                    <div class="dropdown-menu dropdown-menu-end m-0">
                      ...
                      @if($manager && \Illuminate\Support\Facades\Gate::forUser($manager)->allows('check-privilege',
  'edit_status_manager_international_interns'))
        ...
        <div class="row mx-3 justify-content-between">
          ...
          <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto">
            <div class="dt-info" aria-live="polite">
              Showing {{ $interns->firstItem() ?? 0 }} to {{ $interns->lastItem() ?? 0 }} of {{ $interns->total() ??
              0 }} entries
            </div>
          </div>
              ...
              <nav aria-label="pagination">
                <ul class="pagination">
                  ...
                  <li class="dt-paging-button page-item {{ $interns->onFirstPage() ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $interns->url(1) }}" aria-label="First">
                  ...
                  <li class="dt-paging-button page-item {{ $interns->onFirstPage() ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $interns->previousPageUrl() }}" aria-label="Previous">
                      <i class="icon-base ti tabler-chevron-left scaleX-n1-rtl icon-18px"></i>
                    </a>
                  </li>


                  @foreach ($interns->getUrlRange(max(1, $interns->currentPage() - 2), min($interns->lastPage(),
                  ...
                  <li
                    ...
                    <a class="page-link" href="{{ $interns->nextPageUrl() }}" aria-label="Next">
                  ...
                  <li
                    class="dt-paging-button page-item {{ $interns->currentPage() == $interns->lastPage() ? 'disabled' : '' }}">
                    <a class="page-link" href="{{ $interns->url($interns->lastPage()) }}" aria-label="Last">
