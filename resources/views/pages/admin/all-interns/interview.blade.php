    ...
    <div class="d-flex justify-content-start align-items-center user-name">
        <div class="avatar-wrapper">
            ...
            <div class="row mx-3 justify-content-between">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto">
                    <div class="dt-info">
                        Showing {{ $interview->firstItem() ?? 0 }} to {{ $interview->lastItem() ?? 0 }} of {{ $interview->total() ?? 0 }} entries
                    </div>
                </div>
                <div class="d-md-flex align-items-center dt-layout-end col-md-auto ms-auto d-flex gap-2 flex-wrap">
                    <div class="dt-paging">
                        <nav aria-label="pagination">
                            <ul class="pagination">
                                <li class="page-item {{ $interview->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $interview->url(1) }}" aria-label="First">
                                        <i class="icon-base ti tabler-chevrons-left scaleX-n1-rtl icon-18px"></i>
                                    </a>
                                </li>
                                <li class="page-item {{ $interview->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $interview->previousPageUrl() }}" aria-label="Previous">
                                ...
                                <li class="page-item {{ $page == $interview->currentPage() ? 'active' : '' }}">
                                    <a class="page-link" href="{{ $url }}">{{ $page }}</a>
                                </li>
                                @endforeach
                                <li class="page-item {{ $interview->currentPage() == $interview->lastPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $interview->nextPageUrl() }}" aria-label="Next">
                                        <i class="icon-base ti tabler-chevron-right scaleX-n1-rtl icon-18px"></i>
                                    </a>
                                </li>
                                <li class="page-item {{ $interview->currentPage() == $interview->lastPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $interview->url($interview->lastPage()) }}" aria-label="Last">
