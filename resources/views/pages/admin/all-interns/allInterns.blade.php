          ...
          <form method="GET" action="{{ route('all-interns-admin') }}" id="filterForm" class="d-flex gap-2">
            ...
            {{-- <div class="btn-group"><button class="btn buttons-collection btn-label-secondary dropdown-toggle"
                ...
                aria-expanded="true"><span><span class="d-flex align-items-center gap-2"><i
                      class="icon-base ti tabler-upload icon-xs"></i> <span
              ...
              <div class="dropdown-menu dt-button-collection" aria-modal="true" role="dialog"
                style="display: block; top: -64.3px; left: 859.3px;">
                <div role="menu"> <a class="dt-button dropdown-item buttons-print" tabindex="0"
                    aria-controls="DataTables_Table_0" href="#"><span><span class="d-flex align-items-center"><i
                          class="icon-base ti tabler-printer me-1"></i>Print</span></span></a> <a
                    class="dt-button dropdown-item buttons-csv buttons-html5" tabindex="0"
                    aria-controls="DataTables_Table_0" href="#"><span><span class="d-flex align-items-center"><i
                          class="icon-base ti tabler-file-text me-1"></i>Csv</span></span></a> <a
                    class="dt-button dropdown-item buttons-excel buttons-html5" tabindex="0"
                    aria-controls="DataTables_Table_0" href="#"><span><span class="d-flex align-items-center"><i
                          class="icon-base ti tabler-file-spreadsheet me-1"></i>Excel</span></span></a> <a
                    class="dt-button dropdown-item buttons-pdf buttons-html5" tabindex="0"
                    aria-controls="DataTables_Table_0" href="#"><span><span class="d-flex align-items-center"><i
                          class="icon-base ti tabler-file-description me-1"></i>Pdf</span></span></a> <a
                    class="dt-button dropdown-item buttons-copy buttons-html5" tabindex="0"
                    aria-controls="DataTables_Table_0" href="#"><span><i
                        class="icon-base ti tabler-copy me-1"></i>Copy</span></a> </div>
              </div>
            </div> --}}
            ...
            <div class="btn-group" role="group">
              ...
              <div class="dropdown-menu" style="z-index: 1021" aria-labelledby="btnGroupDrop1">
                <a class="dt-button dropdown-item" href="javascript:void(0);" onclick="downloadCSV()">
                  <span>
            ...
            <thead class="border-top sticky-top bg-card">
              <tr>
                ...
                <th data-dt-column="2" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc text-nowrap"
                  aria-label="Profile Picture" tabindex="0"><span class="dt-column-title" role="button">Profile
      ...
      <div class="row mx-3 justify-content-between">
        ...
        <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto">
          <div class="dt-info" aria-live="polite">
            Showing {{ $allInterns->firstItem() ?? 0 }} to {{ $allInterns->lastItem() ?? 0 }} of {{ $allInterns->total()
            ??
            0 }} entries
          </div>
        </div>
        ...
        <div
          ...
          <div class="dt-paging">
            <nav aria-label="pagination">
              <ul class="pagination">
                {{-- First Page --}}
                <li class="dt-paging-button page-item {{ $allInterns->onFirstPage() ? 'disabled' : '' }}">
                ...
                {{-- Page Numbers --}}
                @foreach ($allInterns->getUrlRange(max(1, $allInterns->currentPage() - 2), min($allInterns->lastPage(),
                $allInterns->currentPage() + 2)) as $page => $url)
                <li class="dt-paging-button page-item {{ $page == $allInterns->currentPage() ? 'active' : '' }}">
                ...
                {{-- Next Page --}}
                <li
                  class="dt-paging-button page-item {{ $allInterns->currentPage() == $allInterns->lastPage() ? 'disabled' : '' }}">
...
<script>
  function downloadCSV() {
    ...
    // Base URL setup
    let url = "{{ route('all.interns.export.csv.admin') }}";
