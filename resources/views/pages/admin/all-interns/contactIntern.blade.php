    ...
    <div class="d-flex justify-content-start align-items-center user-name">
        <div class="avatar-wrapper">
            ...
            <div class="row mx-3 justify-content-between">
                <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto">
                    <div class="dt-info">
                        Showing {{ $contact->firstItem() ?? 0 }} to {{ $contact->lastItem() ?? 0 }} of {{ $contact->total() ?? 0 }} entries
                    </div>
                </div>
                <div class="d-md-flex align-items-center dt-layout-end col-md-auto ms-auto d-flex gap-2 flex-wrap">
                    <div class="dt-paging">
                        <nav aria-label="pagination">
                            <ul class="pagination">
                                <li class="page-item {{ $contact->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $contact->url(1) }}" aria-label="First">
                                ...
                                <li class="page-item {{ $page == $contact->currentPage() ? 'active' : '' }}">
                                ...
                                <li class="page-item {{ $contact->currentPage() == $contact->lastPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $contact->url($contact->lastPage()) }}" aria-label="Last">
