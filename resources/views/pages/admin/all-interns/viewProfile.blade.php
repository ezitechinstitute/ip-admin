        ...
        <div class="col-xl-8 col-lg-7">
            <div class="premium-card p-4 animate-in" style="animation-delay: 0.4s;">
                ...
                <div class="tab-panel" id="tab-details">
                    <div class="row g-2">
                        @php $details = [['label' => 'Full Name', 'value' => $interneeDetails->name, 'icon' => 'bi-person-fill', 'color' => 'primary'],['label' => 'Email', 'value' => $interneeDetails->email, 'icon' => 'bi-envelope-fill', 'color' => 'info'],['label' => 'Phone', 'value' => $interneeDetails->phone, 'icon' => 'bi-telephone-fill', 'color' => 'success'],['label' => 'CNIC', 'value' => $interneeDetails->cnic, 'icon' => 'bi-card-text', 'color' => 'warning'],['label' => 'Gender', 'value' => $interneeDetails->gender, 'icon' => 'bi-gender-ambiguous', 'color' => 'secondary'],['label' => 'Date of Birth', 'value' => $interneeDetails->birth_date, 'icon' => 'bi-cake2-fill', 'color' => 'danger'],['label' => 'Join Date', 'value' => $interneeDetails->join_date, 'icon' => 'bi-calendar-check-fill', 'color' => 'success'],['label' => 'University', 'value' => $interneeDetails->university, 'icon' => 'bi-building', 'color' => 'warning'],['label' => 'Country', 'value' => $interneeDetails->country, 'icon' => 'bi-globe2', 'color' => 'info'],['label' => 'City', 'value' => $interneeDetails->city, 'icon' => 'bi-geo-alt-fill', 'color' => 'danger'],['label' => 'Technology', 'value' => $interneeDetails->technology, 'icon' => 'bi-code-slash', 'color' => 'primary'],['label' => 'Duration', 'value' => $interneeDetails->duration, 'icon' => 'bi-clock-fill', 'color' => 'info'],['label' => 'Status', 'value' => $interneeDetails->status, 'icon' => 'bi-flag-fill', 'color' => 'success']]; @endphp
                        @foreach($details as $detail)<div class="col-md-6"><div class="detail-item"><div class="detail-label"><i class="bi {{ $detail['icon'] }} text-{{ $detail['color'] }} me-1"></i>{{ $detail['label'] }}</div><div class="detail-value">{{ $detail['value'] ?? 'N/A' }}</div></div></div>@endforeach
                    </div>
                </div>
