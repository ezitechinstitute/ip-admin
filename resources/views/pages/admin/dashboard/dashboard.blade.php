      ...
      <div class="d-flex align-items-end row">
        <div class="col-7">
          <div class="card-body text-nowrap">
            <h5 class="card-title mb-0">Admin Dashboard Statistics</h5>
            <p class="mb-2 text-success">Welcome back to Admin Portal!</p>
            <div style="display: flex; flex-direction: column" class="mb-1">
              <h6 class="mb-0">{{$adminDetails->name}}</h6>
              <small class="text-primary mb-1">{{$adminDetails->email}}</small>
            </div>
            <a href="{{route('intern-accounts-admin')}}" class="btn btn-primary">View Interns</a>
          </div>
        </div>
  ...
  <div class="col-xl-6 col-md-12">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        ...
        <a href="{{route('all-interns-admin')}}" class="btn btn-outline-primary rounded-pill btn-xs p-0!">View</a>
      </div>
      <div class="card-body d-flex align-items-end">
        <div class="w-100">
          <div class="row gy-6">
            ...
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                ...
                <div class="card-info">
                  <h5 class="mb-0">{{$activeInterns}}</h5>
  ...
  <div class="col-xl-6 col-md-12">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        ...
        <a href="{{route('intern-projects')}}" class="btn btn-outline-primary rounded-pill btn-xs p-0!">View</a>
      </div>
      <div class="card-body d-flex align-items-end">
        <div class="w-100">
          <div class="row gy-6">
