...
<div class="col-12 mb-6">
  <h4 class="mt-6 mb-1">Project Tasks</h4>
    ...
    <div id="DataTables_Table_0_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
      <div class="row m-3 my-0 justify-content-between">
        ...
        <div
          ...
          <form method="GET" action="{{ route('project.tasks') }}" id="filterForm" class="d-flex gap-2">

            <input type="search" name="search" id="searchInput" class="form-control" placeholder="Search Project Tasks..."
          ...
          <table class="datatables-users table dataTable dtr-column" id="DataTables_Table_0"
              ...
              <tr>
                ...
                <th data-dt-column="4" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc text-nowrap"
                  aria-label="City" tabindex="0"><span class="dt-column-title" role="button">Task Title</span><span
                    ...
                    <th data-dt-column="4" rowspan="1" colspan="1" class="dt-orderable-asc dt-orderable-desc text-nowrap"
                  aria-label="City" tabindex="0"><span class="dt-column-title" role="button">Project Title</span><span
                    class="dt-column-order"></span></th>
            ...
            <tbody>
              ...
              <tr class="">
                ...
                <td><span
                    class="text-truncate d-flex align-items-center text-heading text-nowrap">{{$task->project->title}}</span>
                </td>
                <td><span
                      ...
                      <div class="modal-dialog modal-md modal-simple modal-dialog-centered">
                        <div class="modal-content p-2">
                          <div class="modal-body">
                            ...
                            <form id="editInternForm" class="row g-3" action="{{route('update.project.task.admin')}}"
                              method="POST">
                              @csrf
                              ...
                              <div class="col-12 col-md-6 mb-3">
                                ...
                                <select name="task_status" required id="task_status" class="form-select text-capitalize">
...
<script>
  function downloadProjectTasksCSV() {
    ...
    let exportUrl = "{{ route('export.project.tasks.admin') }}";
