...
@section('title', 'Interview Test')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="mb-4">Interview Test</h4>

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Interview Test Intern List</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center">No interns in test phase found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
