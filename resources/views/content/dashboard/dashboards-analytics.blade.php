...
<div class="row g-6">
  ...
  <div class="col-xl-12 col-md-12">
            ...
            <div class="col-md-3 col-6">
              <div class="d-flex align-items-center">
                ...
                <div class="card-info">
                  ...
                  <small>Interview (pending candidates)</small>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-6">
              <div class="d-flex align-items-center">
                ...
                <div class="card-info">
                  ...
                  <small>Contacted Candidates</small>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-6">
   ...
   <div class="col-xl-6 col-md-12">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        <h5 class="card-title mb-0">Intern Statistics</h5>
      </div>
      <div class="card-body d-flex align-items-end">
        <div class="w-100">
          <div class="row gy-6">
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                ...
                <div class="card-info">
                  <h5 class="mb-0">230k</h5>
                  <small>Total Interns (since Ezitech inception)</small>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                <div class="badge rounded bg-label-info me-4 p-2"><i class="icon-base ti tabler-activity icon-lg"></i>
                </div>
                <div class="card-info">
                  <h5 class="mb-0">8.549k</h5>
                  <small>Active Interns</small>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-6">
        ...
        <div class="w-100">
          <div class="row gy-6">
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                <div class="badge rounded bg-label-primary me-4 p-2">
                 <i class="icon-base ti tabler-loader-2 icon-lg"></i>
                </div>
                <div class="card-info">
                  <h5 class="mb-0">230k</h5>
                  <small>Ongoing</small>
            ...
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                <div class="badge rounded bg-label-info me-4 p-2"><i class="icon-base ti tabler-send icon-lg"></i>
                </div>
                <div class="card-info">
                  <h5 class="mb-0">8.549k</h5>
            ...
            <div class="col-md-6 col-6">
              <div class="d-flex align-items-center">
                <div class="badge rounded bg-label-danger me-4 p-2">
                  <i class="icon-base ti tabler-alarm-off icon-lg"></i>
                </div>
                <div class="card-info">
                  <h5 class="mb-0">9745</h5>
                  <small>Expired (missed deadlines)</small>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="card h-100">
    <div class="card-header d-flex justify-content-between align-items-center">
      <div class="card-title mb-0">
        ...
        <p class="card-subtitle">Onsite vs Remote Stats</p>
      </div>
      <div class="dropdown">
        <button class="btn btn-text-secondary btn-icon rounded-pill text-body-secondary border-0 p-2 me-n1" type="button" data-bs-toggle="dropdown">
  ...
  <a class="dropdown-item filter-mode" href="javascript:void(0);" data-val="yearly">Yearly</a>
    ...
    <div class="card-body">
      <div class="d-flex align-items-center gap-6 mb-4">
        <div class="d-flex align-items-center">
          <span class="badge bg-label-primary p-1_5 rounded me-2"><i class="ti tabler-building-community ti-xs"></i></span>
          <div>
            <p class="mb-0 small">Onsite</p>
            <h6 class="mb-0">842</h6>
          </div>
        </div>
        <div class="d-flex align-items-center">
      ...
      <form id="communicationForm">
        <div class="row g-4">
          ...
          <div class="col-md-4">
            ...
            <select class="form-select select2" id="techStack">
          ...
          <div class="col-12 mt-4">
            ...
            <textarea class="form-control" rows="4" placeholder="Type your message for targeted interns..."></textarea>
          </div>
