...
function loadSearchData() {
  const searchJson = 'search-manager-vertical.json';
...
function initializeAutocomplete() {
  ...
  return autocomplete({
    ...
    getSources() {
      ...
      if (data.suggestions && data.suggestions.navigation && data.suggestions.navigation.Menu) {
        const menuItems = data.suggestions.navigation.Menu;
